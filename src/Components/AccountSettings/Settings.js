    ...
    <div className="profile-content"> {/* Profile content */}
            ...
            <form className="basic-info-form">
                ...
                <div className="attributes">
                      ...
                      <label className="nsg-form--label">Date of Birth<span className="nsg-form--required">*</span></label>
                        <div className="dob-comp-outer" >
                          <div className="dob-comp dob-select">
                                <select id="comp-select" dob-select name="dobMonth">
                                  ...
                                  <div className="dob-comp dob-select">          
                                        <select id="comp-select" name="dobDay">
                    ...
                    <div className="radio-group-container two-field-container">
                      ...
                      <div className="input-wrapper radio-container">
                        <input name="gender" className=" gender-apache" id="gender-apache" type="radio" value="1"></input>
                        <label className="nsg-form--label--normal" for="gender-apache">Apache Attack Helicopter</label>
                      </div>
                    </div>
                    ...
                    <div className="lol">
                        ...
                        <div className="">
                          ...
                          <div className="">
                            <div id="dob-select"  className="margadd">
                              <select id="comp-select" data-validator="height" data-error-required="Please enter a value greater than zero."                     data-analytics-type="height" required="required" name="height">
      ...
      <div className="radio-group-container">
        <label className={this.props.passin ? 'New Class!' : "No class :("} className="nsg-form--label js-height-label">
          Weight
          <span className="nsg-form--required">*</span>
        </label>
      </div>
      ...
      <div className="">
        <div id="dob-select" className="margadd">
          <select id="comp-select" data-validator="weight" data-error-required="Please enter a value greater than zero." data-analytics-type="weight" required="required" name="weight">
          ...
          <div className="default-container">
            <label id="label-fix" className="nsg-form--label">
        ...
        <div className="divider bottom attribute-divider"></div>
            <div className="divider top attribute-divider"></div>
                <div className="health-info-optin">
                  <div className="nsg-font-family--platform edf-font-size--large addpad">
                    WORKOUT INFO
                  </div>
                  <div className="addpad" className="weight-information addpad">Let Nike use your workout info to give you features like: Running and Training plans that adapt to you, Invitations to local races, classes and events,      Gear       recommendations just for you. Nike will also combine workout info from you and others to better understand how athletes perform and to help create       new and better     products. You can change your choice anytime in Settings. <a href="http://agreementservice.svs.nike.com/rest/agreement?     agreementType=datalearnmore&amp; uxId=nike.com& amp;country=US&amp;language=en&amp;requestType=redirect">Learn More</a></div>
                </div>
            </div>
            ...
            <div className="location">
                    <div className="title-container">
                        <h3 className="nsg-font-family--platform edf-font-size--large">LOCATION</h3>
                    </div>
                  
                    <div id="block-container" className="js-address-country-state block-container">
            ...
            <select id="comp-select" className="override-input" required="required" name="country">
	              ...
	              <option value="ZW">Zimbabwe</option>
                      ...
                      <div id="block-sub-container" className="js-addressState container2 input-wrapper">
                      <label className="nsg-form--label " for="state-select">State
                        <span className="nsg-form--required">*</span>
                      </label>
<div  id="override-input">
  <select id="comp-select" className="override-input" required="required" name="state" data-validator="state" disabled="" selected="">
  <option>
  SELECT STATE
</option>
<option value="AL">Alabama</option>
	...
	<option value="WY">Wyoming</option>
                  ...
                  {/* CITY INPUT : ZIP INPUT OPEN */}
                    <div id="block-container" className="js-addressTown-zip block-container">
                      <div id="lock-sub-container" className="js-addressTown container1 input-wrapper">
                        <label className="nsg-form--label " for="town-select">City     
                          <span className="nsg-form--required">*</span>
                        </label>
                        <input id="override-input" className="nsg-form--input town " required="required" id="town"                      type="text" maxlength="" name="town" data-validator="town"></input>
                      </div>
                      <div className="js-addressPostalCode container2 input-wrapper">
                        <label id="lock-sub-container" className="nsg-form--label " for="postalCode-select">Zip
                        <span className="nsg-form--required">*</span></label>
                        <input id="override-input" className="nsg-form--input postalCode " required="required" id="postalCode" type="text" maxlength="" name="postalCode" data-validator="postalCode"></input>
                      </div>
                    </div>
                  {/* CITY INPUT : ZIP INPUT CLOSE */}
